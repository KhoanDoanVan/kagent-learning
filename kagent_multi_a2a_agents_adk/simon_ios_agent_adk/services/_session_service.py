...
class KAgentSessionService(BaseSessionService):
  ...
  This service integrates with the Kagent server to manage session state and persistence through HTTP API calls.
  """
    ...
    *,
    ...
    try:
      ...
      for event_data in events_data:
        events.append(Event.model_computed_fields(event_data["data"]))
  ...
  async def append_event(self, session: Session, event: Event) -> Event:
    ...
    # TO-DO: Potentially pull and update the session from the server
